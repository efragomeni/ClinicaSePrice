...
export const Turno3 = () => {
  ...
  const handleCancelAppointment = (appointment) => {
    navigate("/ReprogramacionesEmpleados", { state: { appointment } });
   ...
   const handlePatientChange = (event) => {
     ...
     if (patientsData) {
       const patient = patientsData.patients.find((p) => p.id === Number.parseInt(patientId))
      ...
      <div className="main-container">
        <div className="content-wrapper">
          ...
          <div className="header-card">
            ...
            <select id="patient-select" className="select" value={selectedPatient.id} onChange={handlePatientChange}>
